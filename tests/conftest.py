...
from whatsauto import Petstore, AsyncPetstore, DefaultAioHttpClient
from whatsauto._utils import is_dict
...
logging.getLogger("whatsauto").setLevel(logging.DEBUG)
